...
import { JsonController, Body, Param, Get, Delete, Post, UploadedFile, QueryParam, Patch, CurrentUser, UnauthorizedError, BadRequestError, HttpError, HttpCode } from "routing-controllers";
...
__decorate([
    ...
    __param(1, Body()),
    __param(2, UploadedFile("file", { options: fileUploadOptions() })),
    __metadata("design:type", Function),
